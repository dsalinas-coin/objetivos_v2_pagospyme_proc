...
class __TwigTemplate_9103fa13fead57870a993127b842912a3c7bb3170d089cbb143a1d6523156a04 extends Twig_Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 197
                echo "                ";
                echo $context["__internal_7f693234e20aef99a0a23c623562dc1dd3f22f11bd95d2d0e71db1af48b3ecc5"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", array()), "forms_by_hash", array()));
                echo "
            ";
            }
            $_parent = $context['_parent'];
...
{% macro form_tree_details(name, data, forms_by_hash) %}
    ...
    {% endfor %}
{% endmacro %}
", "WebProfilerBundle:Collector:form.html.twig", "/var/server/proc/pagospyme/proc-genera-transferencias-express/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}
