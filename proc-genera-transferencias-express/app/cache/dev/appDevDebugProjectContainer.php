...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->setFilterSchemaAssetsExpression('~^(?!clientes_datos|acciones|agendados|clientes_notificaciones|cortes_|examenes_preguntas|interesados|listado|meses|oper_|premios_|razones_fail|tickets_|usuarios2|procesos_|usuarios3|zzborrar_|operadores|sis_alicuotas_iva|sis_tipos_conceptos|sis_tipos_ptoventa|users_|pagos|tablatemp_pagos)~');
        $b->setSQLLogger($a);

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'legacy_db', 'port' => 3306, 'dbname' => 'cdpnew', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('time' => 'datetime'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('65086e681fefd9.99619761')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'emails_to' => 'dsalinas@cobroinmediato.tech',
            ...
            'console.command.ids' => array(
                ...
                14 => 'sensio_distribution.security_checker.command',
            ),
        );
    }
}
