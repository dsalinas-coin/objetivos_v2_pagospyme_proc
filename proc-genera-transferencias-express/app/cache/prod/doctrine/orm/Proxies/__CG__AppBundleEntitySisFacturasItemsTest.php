 ...
 */
class SisFacturasItemsTest extends \AppBundle\Entity\SisFacturasItemsTest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'iditem', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'idfactura', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'idconcepto', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'cantidad', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'pbrutoUnitario', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'total', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'pnetoUnitario', '' . "\0" . 'AppBundle\\Entity\\SisFacturasItemsTest' . "\0" . 'totalNeto');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SisFacturasItemsTest $proxy) {
