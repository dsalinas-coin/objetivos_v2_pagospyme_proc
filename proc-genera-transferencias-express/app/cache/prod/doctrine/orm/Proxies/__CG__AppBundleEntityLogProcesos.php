 ...
 */
class LogProcesos extends \AppBundle\Entity\LogProcesos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\LogProcesos' . "\0" . 'idproceso', '' . "\0" . 'AppBundle\\Entity\\LogProcesos' . "\0" . 'idsubproc', '' . "\0" . 'AppBundle\\Entity\\LogProcesos' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\LogProcesos' . "\0" . 'modulo', '' . "\0" . 'AppBundle\\Entity\\LogProcesos' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\LogProcesos' . "\0" . 'idtipo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LogProcesos $proxy) {
    ...
    public function setIdsubproc($idsubproc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdsubproc', array($idsubproc));

        return parent::setIdsubproc($idsubproc);
    }
    ...
    public function getIdsubproc()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdsubproc', array());

        return parent::getIdsubproc();
    }
