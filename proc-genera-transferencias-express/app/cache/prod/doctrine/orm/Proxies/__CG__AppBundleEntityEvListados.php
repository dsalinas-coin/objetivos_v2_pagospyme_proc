 ...
 */
class EvListados extends \AppBundle\Entity\EvListados implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EvListados' . "\0" . 'idlistado', '' . "\0" . 'AppBundle\\Entity\\EvListados' . "\0" . 'fechaasignacion', '' . "\0" . 'AppBundle\\Entity\\EvListados' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvListados $proxy) {
    ...
    public function getIdlistado()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdlistado();
        }
