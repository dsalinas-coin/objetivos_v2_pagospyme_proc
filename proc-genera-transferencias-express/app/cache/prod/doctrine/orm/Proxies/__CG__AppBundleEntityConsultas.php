 ...
 */
class Consultas extends \AppBundle\Entity\Consultas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Consultas' . "\0" . 'idconsulta', '' . "\0" . 'AppBundle\\Entity\\Consultas' . "\0" . 'idlistado', '' . "\0" . 'AppBundle\\Entity\\Consultas' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\Consultas' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Consultas' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\Consultas' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Consultas $proxy) {
    ...
    public function setIdlistado($idlistado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdlistado', array($idlistado));

        return parent::setIdlistado($idlistado);
    }
    ...
    public function getIdlistado()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdlistado', array());

        return parent::getIdlistado();
    }
