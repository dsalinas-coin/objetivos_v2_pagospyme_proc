 ...
 */
class SisTareasPrioridades extends \AppBundle\Entity\SisTareasPrioridades implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SisTareasPrioridades' . "\0" . 'idprioridad', '' . "\0" . 'AppBundle\\Entity\\SisTareasPrioridades' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\SisTareasPrioridades' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\SisTareasPrioridades' . "\0" . 'orden');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SisTareasPrioridades $proxy) {
    ...
    public function getIdprioridad()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdprioridad();
        }
