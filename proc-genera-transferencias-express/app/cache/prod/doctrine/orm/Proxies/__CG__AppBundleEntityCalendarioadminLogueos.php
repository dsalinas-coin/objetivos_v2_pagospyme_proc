 ...
 */
class CalendarioadminLogueos extends \AppBundle\Entity\CalendarioadminLogueos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CalendarioadminLogueos' . "\0" . 'idlogueo', '' . "\0" . 'AppBundle\\Entity\\CalendarioadminLogueos' . "\0" . 'fechain', '' . "\0" . 'AppBundle\\Entity\\CalendarioadminLogueos' . "\0" . 'fechaout', '' . "\0" . 'AppBundle\\Entity\\CalendarioadminLogueos' . "\0" . 'idoperador', '' . "\0" . 'AppBundle\\Entity\\CalendarioadminLogueos' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\CalendarioadminLogueos' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CalendarioadminLogueos $proxy) {
