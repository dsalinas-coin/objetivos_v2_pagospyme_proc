 ...
 */
class MediospagoTipos extends \AppBundle\Entity\MediospagoTipos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MediospagoTipos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\MediospagoTipos' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\MediospagoTipos' . "\0" . 'idtipo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MediospagoTipos $proxy) {
