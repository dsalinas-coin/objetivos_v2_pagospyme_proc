 ...
 */
class ClientesMontos extends \AppBundle\Entity\ClientesMontos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ClientesMontos' . "\0" . 'idmonto', '' . "\0" . 'AppBundle\\Entity\\ClientesMontos' . "\0" . 'monto', '' . "\0" . 'AppBundle\\Entity\\ClientesMontos' . "\0" . 'observacion', '' . "\0" . 'AppBundle\\Entity\\ClientesMontos' . "\0" . 'fechaIngreso', '' . "\0" . 'AppBundle\\Entity\\ClientesMontos' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\ClientesMontos' . "\0" . 'idcliente');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClientesMontos $proxy) {
    ...
    public function getIdmonto()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdmonto();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdmonto', array());

        return parent::getIdmonto();
    }
