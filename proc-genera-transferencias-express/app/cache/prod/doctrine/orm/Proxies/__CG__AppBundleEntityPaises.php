 ...
 */
class Paises extends \AppBundle\Entity\Paises implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Paises' . "\0" . 'idpais', '' . "\0" . 'AppBundle\\Entity\\Paises' . "\0" . 'descripcion');
        }
