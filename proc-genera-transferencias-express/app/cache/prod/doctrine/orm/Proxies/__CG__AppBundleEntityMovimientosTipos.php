 ...
 */
class MovimientosTipos extends \AppBundle\Entity\MovimientosTipos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MovimientosTipos' . "\0" . 'idmovimientoTipo', '' . "\0" . 'AppBundle\\Entity\\MovimientosTipos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\MovimientosTipos' . "\0" . 'observaciones', '' . "\0" . 'AppBundle\\Entity\\MovimientosTipos' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\MovimientosTipos' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MovimientosTipos $proxy) {
    ...
    public function getIdmovimientoTipo()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdmovimientoTipo();
        }
