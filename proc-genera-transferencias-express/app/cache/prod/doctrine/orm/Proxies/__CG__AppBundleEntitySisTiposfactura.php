 ...
 */
class SisTiposfactura extends \AppBundle\Entity\SisTiposfactura implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SisTiposfactura' . "\0" . 'idtipoFactura', '' . "\0" . 'AppBundle\\Entity\\SisTiposfactura' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\SisTiposfactura' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\SisTiposfactura' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SisTiposfactura $proxy) {
    ...
    public function getIdtipoFactura()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdtipoFactura();
        }
