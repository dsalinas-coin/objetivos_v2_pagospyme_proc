 ...
 */
class SisTareasEstadosdet extends \AppBundle\Entity\SisTareasEstadosdet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SisTareasEstadosdet' . "\0" . 'idestado', '' . "\0" . 'AppBundle\\Entity\\SisTareasEstadosdet' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\SisTareasEstadosdet' . "\0" . 'orden');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SisTareasEstadosdet $proxy) {
