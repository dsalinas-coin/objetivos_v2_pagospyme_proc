 ...
 */
class Pruebasms extends \AppBundle\Entity\Pruebasms implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pruebasms' . "\0" . 'idsms', '' . "\0" . 'AppBundle\\Entity\\Pruebasms' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Pruebasms' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Pruebasms' . "\0" . 'smsenviado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pruebasms $proxy) {
