 ...
 */
class NotascreditoAplicacion extends \AppBundle\Entity\NotascreditoAplicacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'idaplicacion', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'idnotacredito', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'fechaingreso', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'fechaaplicacion', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'importe', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'idtipoaplicacion', '' . "\0" . 'AppBundle\\Entity\\NotascreditoAplicacion' . "\0" . 'idasoc');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NotascreditoAplicacion $proxy) {
