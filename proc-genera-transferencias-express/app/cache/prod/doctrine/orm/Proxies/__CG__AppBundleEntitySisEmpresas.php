 ...
 */
class SisEmpresas extends \AppBundle\Entity\SisEmpresas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SisEmpresas' . "\0" . 'idempresa', '' . "\0" . 'AppBundle\\Entity\\SisEmpresas' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\SisEmpresas' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SisEmpresas $proxy) {
    ...
    public function getIdempresa()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdempresa();
        }
