 ...
 */
class PruebaUsuarios extends \AppBundle\Entity\PruebaUsuarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PruebaUsuarios' . "\0" . 'idusuario', '' . "\0" . 'AppBundle\\Entity\\PruebaUsuarios' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\PruebaUsuarios' . "\0" . 'idpais');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PruebaUsuarios $proxy) {
