 ...
 */
class FacturacionItems extends \AppBundle\Entity\FacturacionItems implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\FacturacionItems' . "\0" . 'iditem', '' . "\0" . 'AppBundle\\Entity\\FacturacionItems' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\FacturacionItems' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacturacionItems $proxy) {
