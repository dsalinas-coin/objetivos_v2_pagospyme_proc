 ...
 */
class Pagofacil extends \AppBundle\Entity\Pagofacil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pagofacil' . "\0" . 'idcupon', '' . "\0" . 'AppBundle\\Entity\\Pagofacil' . "\0" . 'idcobro', '' . "\0" . 'AppBundle\\Entity\\Pagofacil' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\Pagofacil' . "\0" . 'cupon');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pagofacil $proxy) {
