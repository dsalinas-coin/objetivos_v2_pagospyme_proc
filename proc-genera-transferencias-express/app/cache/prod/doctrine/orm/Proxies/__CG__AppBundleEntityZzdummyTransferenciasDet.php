 ...
 */
class ZzdummyTransferenciasDet extends \AppBundle\Entity\ZzdummyTransferenciasDet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferenciasDet' . "\0" . 'iddetalle', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferenciasDet' . "\0" . 'idtransferencia', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferenciasDet' . "\0" . 'fechapago', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferenciasDet' . "\0" . 'idzona', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferenciasDet' . "\0" . 'idcategoria', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferenciasDet' . "\0" . 'cantidad', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferenciasDet' . "\0" . 'importe');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ZzdummyTransferenciasDet $proxy) {
