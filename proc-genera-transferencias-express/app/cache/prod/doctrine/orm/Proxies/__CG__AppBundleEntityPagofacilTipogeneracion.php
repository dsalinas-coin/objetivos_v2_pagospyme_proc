 ...
 */
class PagofacilTipogeneracion extends \AppBundle\Entity\PagofacilTipogeneracion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PagofacilTipogeneracion' . "\0" . 'idtipogeneracion', '' . "\0" . 'AppBundle\\Entity\\PagofacilTipogeneracion' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\PagofacilTipogeneracion' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PagofacilTipogeneracion $proxy) {
    ...
    public function getIdtipogeneracion()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdtipogeneracion();
        }
