 ...
 */
class Partidos extends \AppBundle\Entity\Partidos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Partidos' . "\0" . 'idpartido', '' . "\0" . 'AppBundle\\Entity\\Partidos' . "\0" . 'idzona', '' . "\0" . 'AppBundle\\Entity\\Partidos' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Partidos $proxy) {
