 ...
 */
class Bancos2 extends \AppBundle\Entity\Bancos2 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Bancos2' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\Bancos2' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Bancos2' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\Bancos2' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Bancos2 $proxy) {
