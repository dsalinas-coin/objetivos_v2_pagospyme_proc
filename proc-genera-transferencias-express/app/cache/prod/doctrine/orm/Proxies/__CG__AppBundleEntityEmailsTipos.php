 ...
 */
class EmailsTipos extends \AppBundle\Entity\EmailsTipos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EmailsTipos' . "\0" . 'idtipo', '' . "\0" . 'AppBundle\\Entity\\EmailsTipos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\EmailsTipos' . "\0" . 'observaciones');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmailsTipos $proxy) {
