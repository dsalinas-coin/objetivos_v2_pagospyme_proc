 ...
 */
class DebitosEstados extends \AppBundle\Entity\DebitosEstados implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\DebitosEstados' . "\0" . 'idestado', '' . "\0" . 'AppBundle\\Entity\\DebitosEstados' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\DebitosEstados' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\DebitosEstados' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DebitosEstados $proxy) {
