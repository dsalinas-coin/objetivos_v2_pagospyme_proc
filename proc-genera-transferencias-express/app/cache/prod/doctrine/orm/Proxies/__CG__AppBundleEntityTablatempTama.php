 ...
 */
class TablatempTama extends \AppBundle\Entity\TablatempTama implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TablatempTama' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\TablatempTama' . "\0" . 'idusuario', '' . "\0" . 'AppBundle\\Entity\\TablatempTama' . "\0" . 'numcliente', '' . "\0" . 'AppBundle\\Entity\\TablatempTama' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\TablatempTama' . "\0" . 'numero');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TablatempTama $proxy) {
