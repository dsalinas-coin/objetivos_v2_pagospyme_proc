 ...
 */
class SisTareasCategorias extends \AppBundle\Entity\SisTareasCategorias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SisTareasCategorias' . "\0" . 'idcategoria', '' . "\0" . 'AppBundle\\Entity\\SisTareasCategorias' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\SisTareasCategorias' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SisTareasCategorias $proxy) {
