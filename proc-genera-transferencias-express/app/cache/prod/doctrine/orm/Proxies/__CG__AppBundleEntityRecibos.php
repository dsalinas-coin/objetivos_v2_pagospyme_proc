 ...
 */
class Recibos extends \AppBundle\Entity\Recibos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'idrecibo', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'idservicio', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'nrocomprobante', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'fechaemision', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'fechavto', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'fechaingreso', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'observacion', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'importe', '' . "\0" . 'AppBundle\\Entity\\Recibos' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Recibos $proxy) {
    ...
    public function setNrocomprobante($nrocomprobante)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNrocomprobante', array($nrocomprobante));
    ...
    public function getNrocomprobante()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNrocomprobante', array());
