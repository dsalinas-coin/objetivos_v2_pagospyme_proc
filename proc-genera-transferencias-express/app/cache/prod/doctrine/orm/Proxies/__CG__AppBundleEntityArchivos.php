 ...
 */
class Archivos extends \AppBundle\Entity\Archivos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Archivos' . "\0" . 'idarchivo', '' . "\0" . 'AppBundle\\Entity\\Archivos' . "\0" . 'fechaingreso', '' . "\0" . 'AppBundle\\Entity\\Archivos' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Archivos' . "\0" . 'ruta', '' . "\0" . 'AppBundle\\Entity\\Archivos' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\Archivos' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Archivos $proxy) {
