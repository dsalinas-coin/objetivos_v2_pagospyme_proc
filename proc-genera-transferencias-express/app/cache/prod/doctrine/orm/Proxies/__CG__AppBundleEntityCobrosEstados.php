 ...
 */
class CobrosEstados extends \AppBundle\Entity\CobrosEstados implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CobrosEstados' . "\0" . 'idcobroEstado', '' . "\0" . 'AppBundle\\Entity\\CobrosEstados' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\CobrosEstados' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CobrosEstados $proxy) {
    ...
    public function getIdcobroEstado()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdcobroEstado();
        }
