 ...
 */
class TransferenciasCateg extends \AppBundle\Entity\TransferenciasCateg implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TransferenciasCateg' . "\0" . 'idcategoria', '' . "\0" . 'AppBundle\\Entity\\TransferenciasCateg' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransferenciasCateg $proxy) {
