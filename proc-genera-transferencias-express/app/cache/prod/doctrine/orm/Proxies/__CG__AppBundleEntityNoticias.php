...
class Noticias extends \AppBundle\Entity\Noticias implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Noticias' . "\0" . 'idnoticia', '' . "\0" . 'AppBundle\\Entity\\Noticias' . "\0" . 'url', '' . "\0" . 'AppBundle\\Entity\\Noticias' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Noticias' . "\0" . 'texto', '' . "\0" . 'AppBundle\\Entity\\Noticias' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\Noticias' . "\0" . 'estado');
        }
