 ...
 */
class Liquidaciones extends \AppBundle\Entity\Liquidaciones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Liquidaciones' . "\0" . 'idliquidacion', '' . "\0" . 'AppBundle\\Entity\\Liquidaciones' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\Liquidaciones' . "\0" . 'fechaIngreso', '' . "\0" . 'AppBundle\\Entity\\Liquidaciones' . "\0" . 'activo', '' . "\0" . 'AppBundle\\Entity\\Liquidaciones' . "\0" . 'idarchivo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Liquidaciones $proxy) {
    ...
    public function getIdliquidacion()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdliquidacion();
        }
