 ...
 */
class ZzdummyTransferencias extends \AppBundle\Entity\ZzdummyTransferencias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'idtransferencia', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'idtransferenciaTipo', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'fechaingreso', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'fechadeposito', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'montototal', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'emailEnviado', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'archivoEnviado', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'mediopago', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'nroorden', '' . "\0" . 'AppBundle\\Entity\\ZzdummyTransferencias' . "\0" . 'archivoIdreg');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ZzdummyTransferencias $proxy) {
