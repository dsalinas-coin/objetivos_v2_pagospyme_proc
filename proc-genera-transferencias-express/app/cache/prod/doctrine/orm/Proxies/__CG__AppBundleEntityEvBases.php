 ...
 */
class EvBases extends \AppBundle\Entity\EvBases implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EvBases' . "\0" . 'idbase', '' . "\0" . 'AppBundle\\Entity\\EvBases' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\EvBases' . "\0" . 'fechaingreso', '' . "\0" . 'AppBundle\\Entity\\EvBases' . "\0" . 'nombrearchivo', '' . "\0" . 'AppBundle\\Entity\\EvBases' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvBases $proxy) {
