 ...
 */
class PointerCentros extends \AppBundle\Entity\PointerCentros implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PointerCentros' . "\0" . 'idcentro', '' . "\0" . 'AppBundle\\Entity\\PointerCentros' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\PointerCentros' . "\0" . 'direccion', '' . "\0" . 'AppBundle\\Entity\\PointerCentros' . "\0" . 'zona', '' . "\0" . 'AppBundle\\Entity\\PointerCentros' . "\0" . 'tipo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PointerCentros $proxy) {
