 ...
 */
class Novedades extends \AppBundle\Entity\Novedades implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Novedades' . "\0" . 'idnovedad', '' . "\0" . 'AppBundle\\Entity\\Novedades' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\Novedades' . "\0" . 'fechaingreso', '' . "\0" . 'AppBundle\\Entity\\Novedades' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Novedades' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Novedades' . "\0" . 'idarchivo', '' . "\0" . 'AppBundle\\Entity\\Novedades' . "\0" . 'activo');
        }
    ...
    public function getIdnovedad()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdnovedad();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdnovedad', array());

        return parent::getIdnovedad();
    }
