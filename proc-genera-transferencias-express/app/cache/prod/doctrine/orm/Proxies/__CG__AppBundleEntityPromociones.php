 ...
 */
class Promociones extends \AppBundle\Entity\Promociones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Promociones' . "\0" . 'idpromocion', '' . "\0" . 'AppBundle\\Entity\\Promociones' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Promociones' . "\0" . 'contenido', '' . "\0" . 'AppBundle\\Entity\\Promociones' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Promociones $proxy) {
    ...
    public function getIdpromocion()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdpromocion();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdpromocion', array());

        return parent::getIdpromocion();
    }
