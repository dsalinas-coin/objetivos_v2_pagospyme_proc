 ...
 */
class NotificacionesReversasHistorialPagofacil extends \AppBundle\Entity\NotificacionesReversasHistorialPagofacil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'idnotificacionPf', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'codigoBarras', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'tipoDocumento', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'numeroDocumento', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'numeroUsuario', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'moneda', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'terminalReversa', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'numeroTransaccionReversa', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'terminal', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'numeroTransaccion', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'fechaProcesoPf', '' . "\0" . 'AppBundle\\Entity\\NotificacionesReversasHistorialPagofacil' . "\0" . 'idnotificacion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NotificacionesReversasHistorialPagofacil $proxy) {
    ...
    public function setTerminalReversa($terminalReversa)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTerminalReversa', array($terminalReversa));

        return parent::setTerminalReversa($terminalReversa);
    }
    ...
    public function getTerminalReversa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTerminalReversa', array());

        return parent::getTerminalReversa();
    }
    ...
    public function setNumeroTransaccionReversa($numeroTransaccionReversa)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumeroTransaccionReversa', array($numeroTransaccionReversa));

        return parent::setNumeroTransaccionReversa($numeroTransaccionReversa);
    }
    ...
    public function getNumeroTransaccionReversa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumeroTransaccionReversa', array());

        return parent::getNumeroTransaccionReversa();
    }
