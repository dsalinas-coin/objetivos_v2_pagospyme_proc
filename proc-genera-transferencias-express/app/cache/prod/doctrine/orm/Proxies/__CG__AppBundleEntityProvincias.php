 ...
 */
class Provincias extends \AppBundle\Entity\Provincias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Provincias' . "\0" . 'idprovincia', '' . "\0" . 'AppBundle\\Entity\\Provincias' . "\0" . 'provincia');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Provincias $proxy) {
    ...
    public function getIdprovincia()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdprovincia();
        }
