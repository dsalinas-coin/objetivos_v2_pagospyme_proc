 ...
 */
class LogOperaciones extends \AppBundle\Entity\LogOperaciones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\LogOperaciones' . "\0" . 'idoperacion', '' . "\0" . 'AppBundle\\Entity\\LogOperaciones' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\LogOperaciones' . "\0" . 'tipo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LogOperaciones $proxy) {
