 ...
 */
class OperacionesSpsDetalle extends \AppBundle\Entity\OperacionesSpsDetalle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\OperacionesSpsDetalle' . "\0" . 'iddetalle', '' . "\0" . 'AppBundle\\Entity\\OperacionesSpsDetalle' . "\0" . 'idoperacion', '' . "\0" . 'AppBundle\\Entity\\OperacionesSpsDetalle' . "\0" . 'idfactura', '' . "\0" . 'AppBundle\\Entity\\OperacionesSpsDetalle' . "\0" . 'fechaingreso', '' . "\0" . 'AppBundle\\Entity\\OperacionesSpsDetalle' . "\0" . 'importeparcial', '' . "\0" . 'AppBundle\\Entity\\OperacionesSpsDetalle' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OperacionesSpsDetalle $proxy) {
