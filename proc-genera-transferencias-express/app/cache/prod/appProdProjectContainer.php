...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api.afip.connector' => 'getApi_Afip_ConnectorService',
            'app.apiproblem' => 'getApp_ApiproblemService',
            ...
            'enviatransferenciaspf_command' => 'getEnviatransferenciaspfCommandService',
            'enviatransferenciastj_command' => 'getEnviatransferenciastjCommandService',
            ...
            'generarchivotransferenciaspf_command' => 'getGenerarchivotransferenciaspfCommandService',
            'generarchivotransferenciastj_command' => 'getGenerarchivotransferenciastjCommandService',
            'generaretencionespf_command' => 'getGeneraretencionespfCommandService',
            'generatransferenciaspf_command' => 'getGeneratransferenciaspfCommandService',
            'generatransferenciastj_command' => 'getGeneratransferenciastjCommandService',
            ...
            'test_command' => 'getTestCommandService',
            ...
            'updateclientes_command' => 'getUpdateclientesCommandService',
            ...
            'zzgeneratransferenciastj_command' => 'getZzgeneratransferenciastjCommandService',
        );
        $this->aliases = array(
            'afipbundle\\util\\apiconnector' => 'api.afip.connector',
            'console.command.appbundle_command_enviatransferenciaspagofacilcommand' => 'enviatransferenciaspf_command',
            'console.command.appbundle_command_enviatransferenciastarjetascommand' => 'enviatransferenciastj_command',
            'console.command.appbundle_command_generararchivotransferenciaspagofacilcommand' => 'generarchivotransferenciaspf_command',
            'console.command.appbundle_command_generararchivotransferenciastarjetascommand' => 'generarchivotransferenciastj_command',
            'console.command.appbundle_command_generarretencionespagofacilcommand' => 'generaretencionespf_command',
            'console.command.appbundle_command_generartransferenciaspagofacilcommand' => 'generatransferenciaspf_command',
            'console.command.appbundle_command_generartransferenciastarjetascommand' => 'generatransferenciastj_command',
            'console.command.appbundle_command_testcommand' => 'test_command',
            'console.command.appbundle_command_updateclientescommand' => 'updateclientes_command',
            'console.command.appbundle_command_zzdummygenerartransferenciastarjetascommand' => 'zzgeneratransferenciastj_command',
    ...
    /*
     * Gets the public 'api.afip.connector' shared service.
     *
     * @return \AfipBundle\Util\Connector
     */
    protected function getApi_Afip_ConnectorService()
    {
        return $this->services['api.afip.connector'] = new \AfipBundle\Util\Connector(array('sire' => array('token' => 'https://afip.api.pagospyme.com/company_webservices/4', 'wsdl' => 'https://ws-aplicativos-reca.afip.gob.ar/sire/ws/v1/c2005/2005?wsdl'), 'padron' => array('token' => 'https://afip.api.pagospyme.com/company_webservices/3', 'wsdl' => 'https://aws.afip.gov.ar/sr-padron/webservices/personaServiceA5?WSDL')), $this->get('jms_serializer'), $this->get('logger'), $this->get('translator.default'));
    }

    /*
     * Gets the public 'app.apiproblem' shared service.
     *
     * @return \AfipBundle\Util\ApiProblem
     */
    protected function getApp_ApiproblemService()
    {
        return $this->services['app.apiproblem'] = new \AfipBundle\Util\ApiProblem($this->get('translator.default'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->setFilterSchemaAssetsExpression('~^(?!clientes_datos|acciones|agendados|clientes_notificaciones|cortes_|examenes_preguntas|interesados|listado|meses|oper_|premios_|razones_fail|tickets_|usuarios2|procesos_|usuarios3|zzborrar_|operadores|sis_alicuotas_iva|sis_tipos_conceptos|sis_tipos_ptoventa|users_|pagos|tablatemp_pagos)~');

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'legacy_db', 'port' => 3306, 'dbname' => 'cdpnew', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('time' => 'datetime'));
    }
    ...
    /*
     * Gets the public 'enviatransferenciaspf_command' shared service.
     *
     * @return \AppBundle\Command\EnviaTransferenciasPagofacilCommand
     */
    protected function getEnviatransferenciaspfCommandService()
    {
        return $this->services['enviatransferenciaspf_command'] = new \AppBundle\Command\EnviaTransferenciasPagofacilCommand($this);
    }

    /*
     * Gets the public 'enviatransferenciastj_command' shared service.
     *
     * @return \AppBundle\Command\EnviaTransferenciasTarjetasCommand
     */
    protected function getEnviatransferenciastjCommandService()
    {
        return $this->services['enviatransferenciastj_command'] = new \AppBundle\Command\EnviaTransferenciasTarjetasCommand($this);
    }
    ...
    /*
     * Gets the public 'generarchivotransferenciaspf_command' shared service.
     *
     * @return \AppBundle\Command\GenerarArchivoTransferenciasPagofacilCommand
     */
    protected function getGenerarchivotransferenciaspfCommandService()
    {
        return $this->services['generarchivotransferenciaspf_command'] = new \AppBundle\Command\GenerarArchivoTransferenciasPagofacilCommand($this);
    }

    /*
     * Gets the public 'generarchivotransferenciastj_command' shared service.
     *
     * @return \AppBundle\Command\GenerarArchivoTransferenciasTarjetasCommand
     */
    protected function getGenerarchivotransferenciastjCommandService()
    {
        return $this->services['generarchivotransferenciastj_command'] = new \AppBundle\Command\GenerarArchivoTransferenciasTarjetasCommand($this);
    }

    /*
     * Gets the public 'generaretencionespf_command' shared service.
     *
     * @return \AppBundle\Command\GenerarRetencionesPagofacilCommand
     */
    protected function getGeneraretencionespfCommandService()
    {
        return $this->services['generaretencionespf_command'] = new \AppBundle\Command\GenerarRetencionesPagofacilCommand($this, $this->get('api.afip.connector'));
    }

    /*
     * Gets the public 'generatransferenciaspf_command' shared service.
     *
     * @return \AppBundle\Command\GenerarTransferenciasPagofacilCommand
     */
    protected function getGeneratransferenciaspfCommandService()
    {
        return $this->services['generatransferenciaspf_command'] = new \AppBundle\Command\GenerarTransferenciasPagofacilCommand($this, $this->get('api.afip.connector'));
    }

    /*
     * Gets the public 'generatransferenciastj_command' shared service.
     *
     * @return \AppBundle\Command\GenerarTransferenciasTarjetasCommand
     */
    protected function getGeneratransferenciastjCommandService()
    {
        return $this->services['generatransferenciastj_command'] = new \AppBundle\Command\GenerarTransferenciasTarjetasCommand($this, $this->get('api.afip.connector'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('postmaster@pagospyme.com');
        $a->setPassword('Change2Me');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp-relay.pagospyme.com');
        $instance->setPort(587);
        $instance->setEncryption('tls');
        $instance->setTimeout(30);
        $instance->setSourceIp(NULL);
        $instance->setStreamOptions(array('ssl' => array('verify_peer' => false, 'verify_peer_name' => false)));
    ...
    /*
     * Gets the public 'test_command' shared service.
     *
     * @return \AppBundle\Command\TestCommand
     */
    protected function getTestCommandService()
    {
        return $this->services['test_command'] = new \AppBundle\Command\TestCommand($this, $this->get('api.afip.connector'));
    }
    ...
    /*
     * Gets the public 'updateclientes_command' shared service.
     *
     * @return \AppBundle\Command\UpdateClientesCommand
     */
    protected function getUpdateclientesCommandService()
    {
        return $this->services['updateclientes_command'] = new \AppBundle\Command\UpdateClientesCommand($this, $this->get('api.afip.connector'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('33d4cbd149277e51c5436bbd06a7e7c4c71362cd');
    }
    ...
    /*
     * Gets the public 'zzgeneratransferenciastj_command' shared service.
     *
     * @return \AppBundle\Command\ZzdummyGenerarTransferenciasTarjetasCommand
     */
    protected function getZzgeneratransferenciastjCommandService()
    {
        return $this->services['zzgeneratransferenciastj_command'] = new \AppBundle\Command\ZzdummyGenerarTransferenciasTarjetasCommand($this);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('63ab7b0ce14c06.22379449')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AfipBundle' => 'AfipBundle\\AfipBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'AfipBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AfipBundle'),
            ...
            'driver' => 'pdo_mysql',
            'database_host' => 'legacy_db',
            'database_port' => 3306,
            'database_name' => 'cdpnew',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp-relay.pagospyme.com',
            'mailer_user' => 'postmaster@pagospyme.com',
            'mailer_password' => 'Change2Me',
            'mailer_port' => 587,
            'mailer_encryption' => 'tls',
            'secret' => '33d4cbd149277e51c5436bbd06a7e7c4c71362cd',
            'database_driver' => 'pdo_mysql',
            'emails_to' => 'operaciones@pagospyme.com,administracion@pagospyme.com,gfrencheli@cajadepagos.com,tecnologia@cobroinmediato.tech',
            'url_apigw' => 'https://tef.api.pagospyme.com/commissions',
            'urls' => array(
                'sire' => array(
            ...
            'kernel.secret' => '33d4cbd149277e51c5436bbd06a7e7c4c71362cd',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp-relay.pagospyme.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'postmaster@pagospyme.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Change2Me',
            ...
            'console.command.ids' => array(
                0 => 'generatransferenciaspf_command',
                1 => 'generaretencionespf_command',
                2 => 'generatransferenciastj_command',
                3 => 'zzgeneratransferenciastj_command',
                4 => 'enviatransferenciaspf_command',
                5 => 'enviatransferenciastj_command',
                6 => 'generarchivotransferenciaspf_command',
                7 => 'generarchivotransferenciastj_command',
                8 => 'updateclientes_command',
                9 => 'test_command',
                10 => 'doctrine_cache.contains_command',
                11 => 'doctrine_cache.delete_command',
                12 => 'doctrine_cache.flush_command',
                13 => 'doctrine_cache.stats_command',
            ),
        );
    }
}
