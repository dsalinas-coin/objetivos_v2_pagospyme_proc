...
class NotificacionesReversasHistorialPagofacil
{
     ...
     * @return NotificacionesReversasHistorialPagofacil
     */
     ...
     * Set terminalReversa
     *
     * @param string $terminalReversa
     * @return NotificacionesReversasHistorialPagofacil
     */
    public function setTerminalReversa($terminalReversa)
    {
        $this->terminalReversa = $terminalReversa;
     ...
     * @return string 
     */
    public function getTerminalReversa()
    {
        return $this->terminalReversa;
    }

    /**
     * Set numeroTransaccionReversa
     *
     * @param string $numeroTransaccionReversa
     * @return NotificacionesReversasHistorialPagofacil
     */
    public function setNumeroTransaccionReversa($numeroTransaccionReversa)
    {
        $this->numeroTransaccionReversa = $numeroTransaccionReversa;

        return $this;
    }

    /**
     * Get numeroTransaccionReversa
     *
     * @return string 
     */
    public function getNumeroTransaccionReversa()
    {
        return $this->numeroTransaccionReversa;
    }
     ...
     * Set idnotificacion
     *
     * @param \AppBundle\Entity\NotificacionesReversasHistorial $idnotificacion
     * @return NotificacionesReversasHistorialPagofacil
     */
    public function setIdnotificacion(\AppBundle\Entity\NotificacionesReversasHistorial $idnotificacion = null)
    {
     ...
     * Get idnotificacion
     *
     * @return \AppBundle\Entity\NotificacionesReversasHistorial 
     */
